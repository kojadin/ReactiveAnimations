...
public class ViewAnimatorCreator {
    ...
    */
    ...
    public static ViewPropertyAnimator animateScaleUp(View view, TimeInterpolator interpolator) {
        return animateScaleUp(view, DEFAULT_ANIMATION_DURATION, DEFAULT_ANIMATION_DELAY, interpolator);
    }
    ...
    public static ViewPropertyAnimator animateScaleUp(View view, int delay, TimeInterpolator interpolator) {
    ...
    */
    ...
    public static ViewPropertyAnimator animateFadeIn(View view, TimeInterpolator interpolator) {
        return animateFadeIn(view, DEFAULT_ANIMATION_DURATION, DEFAULT_ANIMATION_DELAY, interpolator);
    }

    public static ViewPropertyAnimator animateFadeIn(View view, int delay, TimeInterpolator interpolator) {
        return animateScaleDown(view, DEFAULT_ANIMATION_DURATION, delay, interpolator);
    }
    ...
    */
    ...
    public static ViewPropertyAnimator animateFadeOut(View view, int delay, TimeInterpolator interpolator) {
